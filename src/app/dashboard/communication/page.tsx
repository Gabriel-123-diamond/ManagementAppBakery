...
function ViewReportsTab() {
    ...
    const filteredReports = useMemo(() => {
        return reports.filter(report => {
            ...
            let dateMatch = true;
            if (dateFilter?.from && report.timestamp) {
                ...
                dateMatch = reportDate >= from && reportDate <= to;
            }

            return statusMatch && typeMatch && staffMatch && dateMatch;
        });
    }, [reports, activeTab, typeFilter, staffFilter, dateFilter]);
